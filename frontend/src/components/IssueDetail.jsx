    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      >
          ...
          >
            <div className="relative">
              ...
              <div className="relative">
                ...
                <motion.input
                  ...
                  required
                  className="w-full pl-10 pr-4 py-3 bg-white/5 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300"
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <motion.textarea
                  ...
                  onChange={handleChange}
                  required
                  className="w-full pl-10 pr-4 py-3 bg-white/5 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 resize-y"
                  rows="5"
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                <motion.select
                  ...
                  onChange={handleChange}
                  className="w-full pl-10 pr-4 py-3 bg-white/5 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 appearance-none"
                  whileFocus={{ scale: 1.01 }}
            ...
            <div className="flex gap-3">
              ...
              <motion.button
                ...
                className="flex items-center bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition-all duration-300"
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
        ...
        <p className="mt-6 text-center text-gray-300 text-sm">
          <a href="/issuelist" className="text-blue-400 hover:text-blue-300 font-medium transition-colors duration-200">
            Back to Issues
          </a>
        </p>
      </motion.div>
